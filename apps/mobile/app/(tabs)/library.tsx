...
const s = StyleSheet.create({
  ...
  guestBannerText: { color: '#9ca3af', fontSize: 12, lineHeight: 18 },
  guestBannerButton: {
    alignItems: 'center',
  ...
  savedGuestText: { color: '#9ca3af', fontSize: 12, lineHeight: 18 },
  savedGuestButton: {
    alignItems: 'center',
  ...
  savedEmptyText: { color: '#9ca3af', fontSize: 12, lineHeight: 18 },
  continueFeatureCard: {
    flexDirection: 'row',
    gap: 14,
    marginHorizontal: 16,
  ...
  continueFeatureAuthor: { color: '#9ca3af', fontSize: 12, marginBottom: 10 },
  continueFeatureProgress: { color: '#9ca3af', fontSize: 11, marginTop: 5, marginBottom: 10 },
  continueFeatureBtn: {
    flexDirection: 'row',
    alignItems: 'center',
    gap: 5,
  ...
  bookAuthorGrid: { color: '#9ca3af', fontSize: 12, marginTop: 2 },
  webHiddenScreen: {
    display: 'none',
  },
});
