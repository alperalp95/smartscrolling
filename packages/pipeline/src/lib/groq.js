...
import { evaluateFactMedia } from './fact-media-policy.js';
...
function normalizeFactPayload(
  ...
  const normalizedCategory = normalizeCategory(parsed.category, categoryHint);
  ...
  return {
    ...
    verified: true,
    media_url: mediaPolicy.ok ? imageUrl || null : null,
...
function buildSourceContext(rawText, sourceTitle, categoryHint, sourceLabel) {
