...
const CATEGORY_SEED_TOPICS = {
  ...
  biography: ['Nikola Tesla', 'Thomas Edison', 'Albert Einstein', 'Marie Curie', 'Leonardo da Vinci', 'Lionel Messi', 'Rafael Nadal', 'Michael Jackson', 'Martin Luther King Jr.', 'Ada Lovelace'],
};
